...
const sims = [
  { path: '/security/encryption', title: 'Encryption Lab', desc: 'Encrypt and decrypt text with real cipher logic — symmetric and asymmetric', icon: 'enhanced_encryption' },
  { path: '/security/vpn', title: 'VPN Tunnel', desc: 'Visualize packet encapsulation through an encrypted IPsec tunnel', icon: 'vpn_lock' },
  { path: '/security/firewall', title: 'Firewall Rules', desc: 'Configure ACL rules and watch packets get allowed or denied', icon: 'shield' },
];

export default function SecurityHub() {
  return (
    <div className="p-12 animate-fade-in">
      <span className="text-[10px] font-headline font-bold text-primary uppercase tracking-[0.2em]">Module 06</span>
      <h1 className="text-6xl font-black font-headline text-white tracking-tighter mt-2 mb-4">Security</h1>
      <p className="text-on-secondary-container text-lg max-w-2xl mb-12">Deep dive into cryptographic primitives, tunneling, and perimeter defense mechanisms.</p>
