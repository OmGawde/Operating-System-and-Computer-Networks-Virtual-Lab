...
const sims = [
  { path: '/network-layer/arp', title: 'ARP Resolution', desc: 'Watch ARP broadcast and reply resolve IP to MAC addresses', icon: 'hub' },
  { path: '/network-layer/icmp', title: 'ICMP (Ping)', desc: 'Simulate Echo Request/Reply with TTL and round-trip timing', icon: 'radar' },
];

export default function NetworkLayerHub() {
  return (
    <div className="p-12 animate-fade-in">
      <span className="text-[10px] font-headline font-bold text-primary uppercase tracking-[0.2em]">Module 05</span>
      <h1 className="text-6xl font-black font-headline text-white tracking-tighter mt-2 mb-4">Network Layer</h1>
      <p className="text-on-secondary-container text-lg max-w-2xl mb-12">Explore address resolution and network diagnostics at Layer 3.</p>
